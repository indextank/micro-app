 ...
 */
class RateLimit extends BaseUser implements RateLimitInterface
{
    /**
     * @var int
     */
    public $rateWindowSize = 600;
    ...
    public function getRateLimit($request, $action)
    {
        ...
        return [\Yii::$app->params['rate.limit'] ?? 1200, \Yii::$app->params['rate.window.size'] ?? $this->rateWindowSize];
    }
