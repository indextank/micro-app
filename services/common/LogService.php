...
class LogService extends Service
{
    ...
    private function initData()
    {
        ...
        if (Yii::$app->id == CommonEnum::API && !Yii::$app->user->isGuest) {
        ...
        $data['user_agent'] = CommonHelper::detectVersion();
    ...
    private function getLevel($statusCode)
    {
        if ($statusCode < 300) {
            ...
            return CommonEnum::INFO;
        } elseif ($statusCode >= 400 && $statusCode < 500) {
            return CommonEnum::WARNING;
        } elseif ($statusCode >= 500) {
            return CommonEnum::ERROR;
        }
